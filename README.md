...
livestreamId ;
 Image :
Status:
popular video in category : 
heading :
fonts :

laguage selection on top
then popular video with category wise
consider area according to ip
geographical location should be consider to show the video

use cookies to show the best result
language can be shown by labels in ui

all language means the trending videos
more channels ordered by views

gaming popular
section can be shown by popular language or popular category
