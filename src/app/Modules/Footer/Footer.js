                                ...
                                <ul className="nav-menu social_icon_list">
                                    <li>
                                        <a href="https://medium.com/sentinel" className="" alt="" title="" target="_blank" rel="noopener noreferrer">
                                            <Icon viewClass="medium-m social_icon_imgg" icon="medium-m" /></a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="https://twitter.com/sentinel_co" title="Official Twitter Handle" target="_blank" >
                                    ...
                                    <li>
                                        <a href="https://play.google.com/store/apps/details?id=co.sentinel.sentinellite" target="_blank">
                                        <Icon viewClass="appleinc social_icon_imgg" icon="android" alt="Android" title="Google Play Store dVPN App URL" />
                                        </a>
                                    </li>
                                    {/* <li>
