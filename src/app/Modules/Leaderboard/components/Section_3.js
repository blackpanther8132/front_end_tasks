                            ...
                            return (
                                <div>
                                    <div class="numbers">
                                        ...
                                        <p class="paragraph"><span>{temp.rule.list1.var1}</span><a href="https://medium.com/sentinel/sentinels-google-play-android-dvpn-utility-airdrop-ac25ee5fe5f5" target="_blank">{temp.rule.list1.var2}</a>.</p>
                                    </div>
                                    <div class="numbers">
